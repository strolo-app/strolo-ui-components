import styled, { css as css$1, createGlobalStyle } from 'styled-components';
import React__default, { useRef, useMemo, createElement } from 'react';
...
var disabledButtonStyles = css$1(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  border: none;\n  background-color: ", ";\n  color: ", ";\n  cursor: not-allowed;\n"], ["\n  border: none;\n  background-color: ", ";\n  color: ", ";\n  cursor: not-allowed;\n"])), function (_a) {
    var theme = _a.theme;
...
var ButtonStyled = styled(BaseButton)(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  ", "\n"], ["\n  ",
    "\n"])), function (_a) {
...
var Button = function (_a) {
    ...
    var ref = useRef(null);
    var nonLoadingWidth = useMemo(function () {
        if (loading && ref && ref.current) {
            return ref.current.offsetWidth;
        }
        return;
    }, [loading, ref]);
    return (createElement(ButtonStyled, __assign({ disabled: disabled || loading, loading: loading, color: color }, props), loading ? (createElement("div", { style: { width: nonLoadingWidth, textAlign: 'center' } },
        createElement(Spinner, { color: color }))) : (createElement("div", { ref: ref }, props.children))));
};
var OutlinedButtonStyled = styled(BaseButton)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  ", "\n"], ["\n  ",
    "\n"])), function (_a) {
...
var OutlinedButton = function (_a) {
    ...
    return (createElement(OutlinedButtonStyled, __assign({ disabled: disabled || loading, loading: loading }, props), loading ? (createElement("div", { style: { width: nonLoadingWidth, textAlign: 'center' } },
        createElement(Spinner, { color: color }))) : (createElement("div", { ref: ref }, props.children))));
};
...
var Checkbox = React__default.forwardRef(function (_a, ref) {
    ...
    return (React__default.createElement(CheckboxContainer, { className: className, style: style },
        children,
        React__default.createElement(Input, __assign({ type: "checkbox", ref: ref }, props)),
        React__default.createElement(CheckmarkContainer, null,
            React__default.createElement(Checkmark, null))));
});
var Input = styled.input(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n  position: absolute;\n  opacity: 0;\n  cursor: pointer;\n  height: 0;\n  width: 0;\n"], ["\n  position: absolute;\n  opacity: 0;\n  cursor: pointer;\n  height: 0;\n  width: 0;\n"])));
var Checkmark = styled(FontAwesomeIcon).attrs(function () { return ({
    icon: faCheck,
    size: 'xs',
    color: 'white',
}); })(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n  position: absolute;\n  top: 0px;\n  left: 0px;\n  display: none;\n"], ["\n  position: absolute;\n  top: 0px;\n  left: 0px;\n  display: none;\n"])));
var CheckmarkContainer = styled.span(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n  position: absolute;\n  top: 5px;\n  left: 0;\n  height: 16px;\n  width: 16px;\n  border: 2px solid ", ";\n  border-radius: 5px 0;\n  background-color: ", ";\n  &:after {\n    content: '';\n    position: absolute;\n    display: none;\n  }\n"], ["\n  position: absolute;\n  top: 5px;\n  left: 0;\n  height: 16px;\n  width: 16px;\n  border: 2px solid ", ";\n  border-radius: 5px 0;\n  background-color: ", ";\n  &:after {\n    content: '';\n    position: absolute;\n    display: none;\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var CheckboxContainer = styled.label(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  display: block;\n  position: relative;\n  padding-left: 32px;\n  cursor: pointer;\n  -webkit-user-select: none;\n  -moz-user-select: none;\n  -ms-user-select: none;\n  user-select: none;\n\n  & ", ":checked ~ ", " {\n    background-color: ", ";\n  }\n\n  & ", ":checked ~ ", " {\n    & ", " {\n      display: block;\n    }\n  }\n\n  &:hover input ~ ", " {\n    background-color: ", ";\n  }\n"], ["\n  display: block;\n  position: relative;\n  padding-left: 32px;\n  cursor: pointer;\n  -webkit-user-select: none;\n  -moz-user-select: none;\n  -ms-user-select: none;\n  user-select: none;\n\n  & ", ":checked ~ ", " {\n    background-color: ", ";\n  }\n\n  & ", ":checked ~ ", " {\n    & ", " {\n      display: block;\n    }\n  }\n\n  &:hover input ~ ", " {\n    background-color: ", ";\n  }\n"])), Input.toString(), CheckmarkContainer.toString(), function (_a) {
    var theme = _a.theme;
    return theme.colors.gray60;
}, Input.toString(), CheckmarkContainer.toString(), Checkmark.toString(), CheckmarkContainer.toString(), function (_a) {
    var theme = _a.theme;
    return theme.colors.gray20;
});
...
var Logo = function (_a) {
    ...
    return (React__default.createElement("svg", __assign({ width: width, height: width * RATIO, viewBox: "0 0 50 82", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        React__default.createElement("path", { d: "M48.5787 44.7952L33.5405 35.8507C32.1531 35.0256 30.3527 35.4699 29.5191 36.8432L4.79213 77.5796C3.10454 80.3598 6.59645 83.3685 9.14552 81.3305L48.9107 49.5386C50.4943 48.2725 50.3236 45.833 48.5787 44.7952Z", fill: color }),
        React__default.createElement("path", { d: "M1.42134 37.2048L16.4595 46.1493C17.8469 46.9744 19.6473 46.5301 20.4809 45.1568L45.2079 4.42043C46.8955 1.64021 43.4035 -1.36849 40.8545 0.669475L1.08935 32.4614C-0.494337 33.7275 -0.323603 36.167 1.42134 37.2048Z", fill: color })));
};

var Loader = function () {
    return (React__default.createElement(LoadingIcon, null,
        React__default.createElement(Logo, { color: "white", width: 25 })));
};
var LoadingIcon = styled.div(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n  animation-name: spin;\n  animation-duration: 4000ms;\n  animation-iteration-count: infinite;\n  animation-timing-function: ease-in-out;\n  @keyframes spin {\n    0% {\n      transform: rotate(0deg);\n    }\n    10% {\n      transform: rotate(0deg);\n    }\n    50% {\n      transform: rotate(360deg);\n    }\n    100% {\n      transform: rotate(360deg);\n    }\n  }\n\n  width: 60px;\n  height: 60px;\n  min-width: 60px;\n  min-height: 60px;\n  background-color: black;\n  border-radius: 50%;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n"], ["\n  animation-name: spin;\n  animation-duration: 4000ms;\n  animation-iteration-count: infinite;\n  animation-timing-function: ease-in-out;\n  @keyframes spin {\n    0% {\n      transform: rotate(0deg);\n    }\n    10% {\n      transform: rotate(0deg);\n    }\n    50% {\n      transform: rotate(360deg);\n    }\n    100% {\n      transform: rotate(360deg);\n    }\n  }\n\n  width: 60px;\n  height: 60px;\n  min-width: 60px;\n  min-height: 60px;\n  background-color: black;\n  border-radius: 50%;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n"])));
...
var TextInput = styled.input(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["\n  border: 2px solid ", ";\n  border-radius: 2px;\n  height: 56px;\n  width: 100%;\n  padding-left: 16px;\n  font-size: 1.125rem;\n  outline: none;\n  transition: border 0.25s ease-in-out, padding 0.25s ease-in-out;\n\n  &::placeholder {\n    color: ", ";\n    font-weight: 600;\n  }\n  &:hover {\n    border: 2px solid ", ";\n  }\n  &:focus {\n    border: 3px solid ", ";\n    padding-left: 15px;\n  }\n"], ["\n  border: 2px solid ", ";\n  border-radius: 2px;\n  height: 56px;\n  width: 100%;\n  padding-left: 16px;\n  font-size: 1.125rem;\n  outline: none;\n  transition: border 0.25s ease-in-out, padding 0.25s ease-in-out;\n\n  &::placeholder {\n    color: ", ";\n    font-weight: 600;\n  }\n  &:hover {\n    border: 2px solid ", ";\n  }\n  &:focus {\n    border: 3px solid ", ";\n    padding-left: 15px;\n  }\n"])), function (_a) {
    var theme = _a.theme, error = _a.error;
    return (error ? theme.colors.health30 : theme.colors.gray30);
}, function (_a) {
    var theme = _a.theme;
...
var Text = styled.span(templateObject_1$5 || (templateObject_1$5 = __makeTemplateObject(["\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n"], ["\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n"])), function (_a) {
...
var P1 = styled.p(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["\n  font-size: ", ";\n  ", "\n  ", "\n  ", " {\n    font-size: ", ";\n  }\n"], ["\n  font-size: ", ";\n  ", "\n  ", "\n  ", " {\n    font-size: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var P2 = styled.p(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["\n  font-size: ", ";\n  ", "\n  ", "\n  ", " {\n    font-size: ", ";\n  }\n"], ["\n  font-size: ", ";\n  ", "\n  ", "\n  ", " {\n    font-size: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var H6 = styled.h6(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  font-weight: bold;\n  font-size: ", ";\n  ", "\n  ", "\n  ", " {\n    font-size: ", ";\n  }\n"], ["\n  font-weight: bold;\n  font-size: ", ";\n  ", "\n  ", "\n  ", " {\n    font-size: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var H5 = styled.h5(templateObject_5$1 || (templateObject_5$1 = __makeTemplateObject(["\n  font-weight: bold;\n  font-size: ", ";\n  ", "\n  ", "\n  ", " {\n    font-size: ", ";\n  }\n"], ["\n  font-weight: bold;\n  font-size: ", ";\n  ", "\n  ", "\n  ", " {\n    font-size: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var Textarea = styled.textarea(templateObject_1$6 || (templateObject_1$6 = __makeTemplateObject(["\n  border: 2px solid ", ";\n  border-radius: 2px;\n  width: 100%;\n  padding: 16px;\n  font-size: 1.125rem;\n  outline: none;\n  resize: none;\n  transition: border 0.25s ease-in-out, padding 0.25s ease-in-out;\n  &::placeholder {\n    color: ", ";\n    font-weight: 600;\n  }\n  &:hover {\n    border: 2px solid ", ";\n  }\n  &:focus {\n    border: 3px solid ", ";\n    padding-left: 15px;\n  }\n"], ["\n  border: 2px solid ", ";\n  border-radius: 2px;\n  width: 100%;\n  padding: 16px;\n  font-size: 1.125rem;\n  outline: none;\n  resize: none;\n  transition: border 0.25s ease-in-out, padding 0.25s ease-in-out;\n  &::placeholder {\n    color: ", ";\n    font-weight: 600;\n  }\n  &:hover {\n    border: 2px solid ", ";\n  }\n  &:focus {\n    border: 3px solid ", ";\n    padding-left: 15px;\n  }\n"])), function (_a) {
    var theme = _a.theme, error = _a.error;
    return (error ? theme.colors.health30 : theme.colors.gray30);
}, function (_a) {
    var theme = _a.theme;
...
export { Button, Checkbox, GlobalStyle, H1, H2, H3, H4, H5, H6, Loader, Logo, LogoText, OutlinedButton, P1, P2, Select, Text, TextInput, Textarea, defaultTheme };
