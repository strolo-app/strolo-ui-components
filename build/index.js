...
var LoadingIcon = styled__default.div(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n  animation-name: spin;\n  animation-duration: 4000ms;\n  animation-iteration-count: infinite;\n  animation-timing-function: ease-in-out;\n  @keyframes spin {\n    0% {\n      transform: rotate(0deg);\n    }\n    10% {\n      transform: rotate(0deg);\n    }\n    50% {\n      transform: rotate(360deg);\n    }\n    100% {\n      transform: rotate(360deg);\n    }\n  }\n\n  width: 60px;\n  height: 60px;\n  min-width: 60px;\n  min-height: 60px;\n  background-color: black;\n  border-radius: 50%;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n"], ["\n  animation-name: spin;\n  animation-duration: 4000ms;\n  animation-iteration-count: infinite;\n  animation-timing-function: ease-in-out;\n  @keyframes spin {\n    0% {\n      transform: rotate(0deg);\n    }\n    10% {\n      transform: rotate(0deg);\n    }\n    50% {\n      transform: rotate(360deg);\n    }\n    100% {\n      transform: rotate(360deg);\n    }\n  }\n\n  width: 60px;\n  height: 60px;\n  min-width: 60px;\n  min-height: 60px;\n  background-color: black;\n  border-radius: 50%;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n"])));
...
var StyledSelect = styled__default.select(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n  border: 2px solid ", ";\n  border-radius: 2px;\n  height: 56px;\n  width: 100%;\n  padding-left: 16px;\n  font-size: 1.125rem;\n  outline: none;\n  transition: border 0.25s ease-in-out, padding 0.25s ease-in-out;\n  cursor: pointer;\n\n  &::placeholder {\n    color: ", ";\n    font-weight: 600;\n  }\n  &:hover {\n    border: 2px solid ", ";\n  }\n  &:focus {\n    border: 3px solid ", ";\n    padding-left: 15px;\n  }\n"], ["\n  border: 2px solid ", ";\n  border-radius: 2px;\n  height: 56px;\n  width: 100%;\n  padding-left: 16px;\n  font-size: 1.125rem;\n  outline: none;\n  transition: border 0.25s ease-in-out, padding 0.25s ease-in-out;\n  cursor: pointer;\n\n  &::placeholder {\n    color: ", ";\n    font-weight: 600;\n  }\n  &:hover {\n    border: 2px solid ", ";\n  }\n  &:focus {\n    border: 3px solid ", ";\n    padding-left: 15px;\n  }\n"])), function (_a) {
...
var TextInput = styled__default.input(templateObject_1$3 || (templateObject_1$3 = __makeTemplateObject(["\n  border: 2px solid ", ";\n  border-radius: 2px;\n  height: 56px;\n  width: 100%;\n  padding-left: 16px;\n  font-size: 1.125rem;\n  outline: none;\n  transition: border 0.25s ease-in-out, padding 0.25s ease-in-out;\n\n  &::placeholder {\n    color: ", ";\n    font-weight: 600;\n  }\n  &:hover {\n    border: 2px solid ", ";\n  }\n  &:focus {\n    border: 3px solid ", ";\n    padding-left: 15px;\n  }\n"], ["\n  border: 2px solid ", ";\n  border-radius: 2px;\n  height: 56px;\n  width: 100%;\n  padding-left: 16px;\n  font-size: 1.125rem;\n  outline: none;\n  transition: border 0.25s ease-in-out, padding 0.25s ease-in-out;\n\n  &::placeholder {\n    color: ", ";\n    font-weight: 600;\n  }\n  &:hover {\n    border: 2px solid ", ";\n  }\n  &:focus {\n    border: 3px solid ", ";\n    padding-left: 15px;\n  }\n"])), function (_a) {
    var theme = _a.theme, error = _a.error;
    return (error ? theme.colors.health30 : theme.colors.gray30);
}, function (_a) {
    var theme = _a.theme;
