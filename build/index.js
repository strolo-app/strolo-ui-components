...
var BaseButton = styled__default.button.attrs(function (props) { return ({
...
var disabledStyle = styled.css(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  background-color: ", ";\n  color: ", ";\n  cursor: not-allowed;\n"], ["\n  background-color: ", ";\n  color: ", ";\n  cursor: not-allowed;\n"])), function (_a) {
    var theme = _a.theme;
...
var primaryStyleContained = styled.css(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  border: none;\n  background-color: #000000;\n  color: #ffffff;\n\n  &:focus {\n    background-color: ", ";\n  }\n  &:hover {\n    background-color: ", ";\n  }\n"], ["\n  border: none;\n  background-color: #000000;\n  color: #ffffff;\n\n  &:focus {\n    background-color: ", ";\n  }\n  &:hover {\n    background-color: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var primaryStyleOutlined = styled.css(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  border: 2px solid ", ";\n  color: ", ";\n  background-color: rgba(0, 0, 0, 0);\n\n  &:focus,\n  &:hover {\n    border: 3px solid ", ";\n    padding: 0 15px;\n  }\n"], ["\n  border: 2px solid ", ";\n  color: ", ";\n  background-color: rgba(0, 0, 0, 0);\n\n  &:focus,\n  &:hover {\n    border: 3px solid ", ";\n    padding: 0 15px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var energyStyleContained = styled.css(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  border: none;\n  background-color: ", ";\n  color: ", ";\n\n  &:focus {\n    background-color: ", ";\n  }\n  &:hover {\n    background-color: ", ";\n  }\n"], ["\n  border: none;\n  background-color: ", ";\n  color: ", ";\n\n  &:focus {\n    background-color: ", ";\n  }\n  &:hover {\n    background-color: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var energyStyleOutlined = styled.css(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  border: 2px solid ", ";\n  color: ", ";\n  background-color: rgba(0, 0, 0, 0);\n\n  &:focus,\n  &:hover {\n    border: 3px solid ", ";\n    padding: 0 15px;\n  }\n"], ["\n  border: 2px solid ", ";\n  color: ", ";\n  background-color: rgba(0, 0, 0, 0);\n\n  &:focus,\n  &:hover {\n    border: 3px solid ", ";\n    padding: 0 15px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.palette.energy.main;
}, function (_a) {
    var theme = _a.theme;
...
var Button = styled__default(BaseButton)(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  ", "\n"], ["\n  ",
    "\n"
    // &:active {
    //   height: 34px;
