...
var primaryStyle = styled.css(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  background: #000000;\n  color: #ffffff;\n\n  &:focus {\n    border: 2px solid ", ";\n    padding: 0 14px;\n  }\n  &:hover {\n    background: ", ";\n  }\n  &:active {\n    border: none;\n    padding: 0 16px;\n  }\n"], ["\n  background: #000000;\n  color: #ffffff;\n\n  &:focus {\n    border: 2px solid ", ";\n    padding: 0 14px;\n  }\n  &:hover {\n    background: ", ";\n  }\n  &:active {\n    border: none;\n    padding: 0 16px;\n  }\n"])), function (props) { return props.theme.palette.gray[50]; }, function (_a) {
    var theme = _a.theme;
    return theme.palette.primary.light;
});
var energyStyle = styled.css(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  background: ", ";\n  color: ", ";\n\n  &:focus {\n    border: 2px solid ", ";\n    padding: 0 14px;\n  }\n  &:hover {\n    background: ", ";\n  }\n  &:active {\n    border: none;\n    padding: 0 16px;\n  }\n"], ["\n  background: ", ";\n  color: ", ";\n\n  &:focus {\n    border: 2px solid ", ";\n    padding: 0 14px;\n  }\n  &:hover {\n    background: ", ";\n  }\n  &:active {\n    border: none;\n    padding: 0 16px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var Button = styled__default(BaseButton).attrs(function (props) { return ({
    color: props.color || 'primary',
