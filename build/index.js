...
var Text = styled__default.span(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n"], ["\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n"])), function (_a) {
...
var Input$1 = styled__default.input(templateObject_1$5 || (templateObject_1$5 = __makeTemplateObject(["\n  width: 100%;\n  padding-top: 16px;\n  padding-left: 14px;\n  padding-right: ", ";\n  height: 56px;\n  font-size: 1rem;\n  border: 2px solid ", ";\n  border-radius: 2px;\n  transition: border 0.25s ease-in-out, padding 0.25s ease-in-out;\n  caret-color: ", ";\n  outline: none;\n  font-weight: 600;\n  background-color: ", ";\n\n  &::placeholder {\n    color: rgba(0, 0, 0, 0);\n  }\n\n  &:hover {\n    ", "\n  }\n  &:focus {\n    border: 3px solid ", " !important;\n    padding-left: 13px;\n    padding-right: ", ";\n  }\n"], ["\n  width: 100%;\n  padding-top: 16px;\n  padding-left: 14px;\n  padding-right: ", ";\n  height: 56px;\n  font-size: 1rem;\n  border: 2px solid ", ";\n  border-radius: 2px;\n  transition: border 0.25s ease-in-out, padding 0.25s ease-in-out;\n  caret-color: ", ";\n  outline: none;\n  font-weight: 600;\n  background-color: ",
    ";\n\n  &::placeholder {\n    color: rgba(0, 0, 0, 0);\n  }\n\n  &:hover {\n    ",
    "\n  }\n  &:focus {\n    border: 3px solid ", " !important;\n    padding-left: 13px;\n    padding-right: ", ";\n  }\n"])), function (_a) {
...
var Wrapper = styled__default.div(templateObject_3$3 || (templateObject_3$3 = __makeTemplateObject(["\n  position: relative;\n  width: 100%;\n"], ["\n  position: relative;\n  width: 100%;\n"])));
var Span = styled__default.span(templateObject_4$3 || (templateObject_4$3 = __makeTemplateObject(["\n  border: 0;\n  clip: rect(1px 1px 1px 1px);\n  clip: rect(1px, 1px, 1px, 1px);\n  height: 1px;\n  margin: -1px;\n  overflow: hidden;\n  padding: 0;\n  position: absolute;\n  width: 1px;\n"], ["\n  border: 0;\n  clip: rect(1px 1px 1px 1px);\n  clip: rect(1px, 1px, 1px, 1px);\n  height: 1px;\n  margin: -1px;\n  overflow: hidden;\n  padding: 0;\n  position: absolute;\n  width: 1px;\n"])));
var EndAdornment = styled__default.div(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n  width: 56px;\n  height: 56px;\n  position: absolute;\n  right: 0;\n  top: 0;\n  bottom: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n"], ["\n  width: 56px;\n  height: 56px;\n  position: absolute;\n  right: 0;\n  top: 0;\n  bottom: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n"])));
...
var Wrapper$1 = styled__default.div(templateObject_3$4 || (templateObject_3$4 = __makeTemplateObject(["\n  position: relative;\n  width: 100%;\n"], ["\n  position: relative;\n  width: 100%;\n"])));
var Overlay = styled__default.div(templateObject_4$4 || (templateObject_4$4 = __makeTemplateObject(["\n  position: absolute;\n  height: 24px;\n  background-color: ", ";\n  top: 2px;\n  left: 2px;\n  right: 2px;\n  transition: top 0.25s ease-in-out, left 0.25s ease-in-out, right 0.25s ease-in-out;\n  ", ":focus ~ & {\n    top: 3px;\n    left: 3px;\n    right: 3px;\n  }\n"], ["\n  position: absolute;\n  height: 24px;\n  background-color: ",
    ";\n  top: 2px;\n  left: 2px;\n  right: 2px;\n  transition: top 0.25s ease-in-out, left 0.25s ease-in-out, right 0.25s ease-in-out;\n  ", ":focus ~ & {\n    top: 3px;\n    left: 3px;\n    right: 3px;\n  }\n"])), function (_a) {
    var theme = _a.theme, disabled = _a.disabled;
    return !!disabled ? theme.colors.gray20 : theme.colors.gray0;
}, StyledTextarea);
var Span$1 = styled__default.span(templateObject_5$3 || (templateObject_5$3 = __makeTemplateObject(["\n  border: 0;\n  clip: rect(1px 1px 1px 1px);\n  clip: rect(1px, 1px, 1px, 1px);\n  height: 1px;\n  margin: -1px;\n  overflow: hidden;\n  padding: 0;\n  position: absolute;\n  width: 1px;\n"], ["\n  border: 0;\n  clip: rect(1px 1px 1px 1px);\n  clip: rect(1px, 1px, 1px, 1px);\n  height: 1px;\n  margin: -1px;\n  overflow: hidden;\n  padding: 0;\n  position: absolute;\n  width: 1px;\n"])));
